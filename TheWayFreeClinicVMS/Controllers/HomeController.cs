...
namespace TheWayFreeClinicVMS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult ClockConfirm()
        {
            return View();
        }
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult ClockConfirm([Bind(Include = "wrkID,volID,wrkDate,wrkStartTime,wrkEndTime")] Worktime worktime, string email)
        //{
        //    //get id from email
        //    var thisVolID = (from i in db.Volunteers where i.volEmail == email select i.volID).SingleOrDefault();
