...
namespace TheWayFreeClinicVMS.Controllers
{
    public class ManageAvailabilitiesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "volID,avDay,avFrom,avUntil")] Availability availability)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteAvailability(int id)
        {
            ...
            db.SaveChanges();
            return RedirectToAction("UpdateAvailability");
        }
